        ...
        <Container maxWidth="lg" sx={ourteam.FullBox} >
          <Grid container spacing={2} justifyContent="center" >
            <Grid item xs={12} sm={6} md={4}>
              <Typography variant="h5" textAlign="center">3.5 Lakh</Typography>
              <Typography mt={1} variant="body1" textAlign="center">Students Impacted</Typography>
            </Grid>

            <Grid item xs={12} sm={6} md={4}>
              <Typography variant="h5" textAlign="center">2.10 Lakh</Typography>
              <Typography mt={1} variant="body1" textAlign="center">Women Reached</Typography>
            </Grid>

            <Grid item xs={12} sm={6} md={4}>
              <Typography variant="h5" textAlign="center">1,621</Typography>
              <Typography mt={1} variant="body1" textAlign="center">Schools Reached</Typography>
            </Grid>
          </Grid>
          <Grid container spacing={2} justifyContent="center" sx={{ mt: { xs: 2, md: "63px" } }}>
            <Grid item xs={12} sm={6} md={4}>
              <Typography variant="h5" textAlign="center">15,000</Typography>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Typography variant="h5" textAlign="center">1,028</Typography>
              <Typography mt={1} variant="body1" textAlign="center">Job Created</Typography>
            </Grid>
          </Grid>
        </Container>
      </Box>
