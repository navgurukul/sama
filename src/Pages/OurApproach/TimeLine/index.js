            ...
            <Box style={container}>
                <Container maxWidth="xl" style={lgContainer}>
                    ...
                    <Grid container spacing={2} sx={{ display: { xs: 'none', lg: 'flex' }, height: "auto" }}>
                        ...
                        >
                            <Grid Container marginTop="48px" sx={{ padding: { lg: "20px" } }}>
                                                    ...
                                                    return (
                                                        <li>
                                                            <Typography variant='body1'>
                                                                <Typography component="span" sx={{ fontWeight: 'bold', fontWeight: 700,color:"rgba(74, 74, 74, 1)" }}>
                                                                    {boldText}:
                                                                </Typography>
                                                                {normalText}
                                                            </Typography>
                                            ...
                                            <ul>
                                                {steps[1].description.map((desc, idx) => {
                                                    ...
                                                    return (
                                                        <li>
                                                            <Typography variant='body1'>
                                                                <Typography variant='' component="span" sx={{ fontWeight: 'bold', fontWeight: 700,color:"rgba(74, 74, 74, 1)" }}>
                                                                    {boldText}:
                                                                </Typography>
                                                                {normalText}
                                                            </Typography>
