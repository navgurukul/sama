    ...
    return (
        <>
                    ...
                    <Grid item xs={12} md={2.4} key={index}>
                        <StyledCard >
                            <CardContent>
                                ...
                                <Typography style={styles.h5} variant="h5" sx={{ mt: 1 }}>{item.number}</Typography>
            ...
            <Grid container spacing={1} mt={3}>
                        ...
                        <CardContent>
                            <Grid container spacing={3} mt={1}>
                                <Grid item xs={12} md={6} style={{ position: "relative", bottom: "14px" }}>
                                    ...
                                    <Typography sx={{ mt: 4 }} variant="h4" style={styles.h5}>17</Typography>
                ...
                <Grid item xs={12} md={6}>
                    <Typography sx={{ mt: 2, ml: 2 }} variant="subtitle1" >SKILLS IMPARTED</Typography>
