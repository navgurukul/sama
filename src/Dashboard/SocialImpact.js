    ...
    return (
        <>
            ...
            <Grid container spacing={1} mt={3}>
                ...
                <Grid item xs={12} md={6}>
                    <Typography variant="subtitle1" sx={{ mt: 2, ml: 2 }} >SKILLS IMPARTED</Typography>
                    <Grid container spacing={3} style={{ padding: "16px" }}>
                        {skills.map((skill, index) => (
                            <Grid item xs={12} md={4} key={index}>
                                <Box display="flex" alignItems="center">
                    ...
                    <Grid container style={{ padding: "16px" }}>
                        <Typography variant="subtitle1" >STUDENT SPEAKS</Typography>
                        <Grid item xs={12} md={12} sx={{ mt: 4 }}>
                            <Box display="flex" alignItems="center">
                                <img src={ZiyaImg} style={{ marginRight: '8px' }} />
                                <Box sx={{ ml: 3 }}>
                                    <Typography variant="subtitle1" >“ Before, I couldn't even turn a laptop on. Now, I can't imagine a day of learning without it ”</Typography>
                                    <Typography variant='body2' sx={{ mt: 2 }}>Ziya Afreen (NavGurukul Student)</Typography>
                                </Box>
                            </Box>
                        </Grid>
                        <Grid item xs={12} md={12} style={{ marginTop: "32px" }}>
                            <Box display="flex" alignItems="center">
                                <img src={Komal} style={{ marginRight: '8px' }} />
                                <Box sx={{ ml: 3 }}>
                                    <Typography variant="subtitle1" > “ This laptop isn't just a tool. It is my bridge from being a novice to a full-fledged future software developer “</Typography>
                                    <Typography variant='body2' sx={{ mt: 2 }}>Komal Chaudhary (NavGurukul Student)</Typography>
                                </Box>
                            </Box>
                        </Grid>
                    </Grid>
