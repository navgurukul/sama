...
//                         ))}
//                     </Grid>
//                     <Box className="carousel-container1">
//                         <Box className="carousel-content1">
//                             {students.map((student, index) => (
//                                 <Grid item xs={12} md={12} key={index} sx={{ mt: index === 0 ? 4 : 8 }}>
//                                     <Box className="carousel-item">
//                                         <Box display="flex" alignItems="center">
//                                             <img src={student.src} alt={student.alt} style={{ marginRight: '8px' }} />
//                                             <Box sx={{ ml: 3 }}>
