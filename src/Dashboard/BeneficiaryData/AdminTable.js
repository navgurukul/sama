...
//     try {
//       // Check if any selected rows are changing from 'Data Uploaded' to 'Laptop Assigned'
//       const isAssigningLaptop = Array.from(selectedRows).some((id) => {
//         const ngo = ngoData.find((n) => n.ID === id);
//         return (
//           (ngo.status || "Data Uploaded") === "Data Uploaded" &&
...
//       // Add timestamp only when changing to 'Laptop Assigned' from 'Data Uploaded'
...
//     const currentStatus = currentNgo.status || "Data Uploaded";
...
//       // Add timestamp only when changing from 'Data Uploaded' to 'Laptop Assigned'
//       if (
