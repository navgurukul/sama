...
//     if (!status?.id) {
//       alert("Error: Status ID is missing");
//       return;
//     }
...
//         "https://script.google.com/macros/s/AKfycbx6DRpDPR7X5Q1fdw6OcmlGyU_cfZQ_p_mA8XBCBGKGg5AH5ilHo6Orrpx31AsDnb-bew/exec?type=deleteManageStatus",
//         {
//           method: "POST",
//           headers: {
...
//           mode: "no-cors",
//           body: JSON.stringify({
//             id: status.id, // Backend expects the ID for deletion
//           }),
//         }
//       );

//       // Check the response (no-cors suppresses responses; validate success in your backend)
//       if (response.ok || response.status === 0) {
//         console.log("Status deleted successfully");
//         onDeleteSuccess(status); // Notify parent about successful deletion
//       } else {
//         throw new Error("Failed to delete status on server");
//       }
//     } catch (error) {
